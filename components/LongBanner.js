      ...
      <div class="container">
        <div class="row px-5">
          <div class="col-3 d-flex flex-column justify-content-center align-items-center ">
            <div className="text-center w-75 pb-2">
              <img
                src="/logo.png"
            ...
            <div className="text-center font-shadow">
              <h5 className="mb-1 city-font-longBanner">{city}</h5>
              <p className="mb-0 small date-font-longBanner">{date}</p>
            </div>
          </div>
                ...
                >
                  <tbody>
                    <tr className="text-center">
                      ...
                      <td className="span-bg-longBanner font-heading">
                        HANAFI
                      </td>
